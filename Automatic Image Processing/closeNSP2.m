% Compute the last step of the algorithm VP-DLSFC
% The center of the reference protein is taken as the center of 
% the accompanying protein, and then the radius of the adjust 
...
function R=closeNSP2(center,x,y)
% Data normalization
u=x-mean(x);
v=y-mean(y);
